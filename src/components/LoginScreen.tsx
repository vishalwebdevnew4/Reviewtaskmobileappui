...
export function LoginScreen({ onNavigate }: LoginScreenProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-white px-6">
      ...
      <button 
        onClick={() => googleLogin()}
        className="w-full bg-white border-2 border-gray-200 rounded-[16px] px-6 py-4 flex items-center justify-center gap-3 hover:border-[#6B4BFF] transition-all mb-4"
      >
